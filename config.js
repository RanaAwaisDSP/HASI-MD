...
global.sudo = process.env.SUDO || '923276232206'
global.devs = '923276232206';
global.website = 'https://github.com/chhaseeb47/HASI-MD' // Hello world
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/04fcceebb3156034d34d6.jpg'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'HASI-MD' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '𝙍𝙖𝙣𝙖 𝘼𝙬𝙖𝙞𝙨' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? '𝙍𝙖𝙣𝙖 𝘼𝙬𝙖𝙞𝙨' : process.env.PACK_AUTHER.split(";")[0],
